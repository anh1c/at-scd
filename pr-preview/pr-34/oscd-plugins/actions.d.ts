 ...
 */
export declare function createActions(lnElement: Element, lnClonedElement: Element, doElement: Element, wizard: Element, ti: string, inverted: boolean, tiInformation: TiInformation): Create[];
/**
 ...
 * @returns A list of Create Action that will be added to the complex action.
 */
export declare function createCheckActions(lnElement: Element, lnClonedElement: Element, doElement: Element, wizard: Element, ti: string, tiInformation: TiInformation): Create[];
